...
abstract class URCL_Field_Settings {
	...
	public function prepare_ui_html( $field_data ) {
		...
		$enabled         = ur_string_to_bool( $enabled_status );
		...
		echo '<div class="ur-toggle-section ur-form-builder-toggle"><span class="user-registration-toggle-form">';
		printf(
		...
		echo '<span class="slider round"></span></span>';
