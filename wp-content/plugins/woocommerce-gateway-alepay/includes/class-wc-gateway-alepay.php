...
//            $_POST['woocommerce_alepay_payment_normal'] = '0';
//        }
    ...
    public function process_payment($order_id) {
        ...
        if (isset($row->token) && $row->token && $_POST['payment_alepay'] === '3') { // namdeveloper
            ...
            $data['amount'] = $order_data['total'];
            $data['buyerAddress'] = $order_oms->get_billing_address_full();
            $data['buyerCity'] = $order_oms->get_billing_city_name();
