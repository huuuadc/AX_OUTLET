...
[DOCUMENTATION](https://yaycommerce.gitbook.io/yaysmtp/) | [GO PRO](https://yaycommerce.com/yaysmtp-wordpress-mail-smtp/)
...
- [YayMail Addons](https://yaycommerce.com/yaymail-woocommerce-email-customizer/#conditional-logic)
- [WooCommerce Multi-Currency Switcher](https://yaycommerce.com/yaycurrency-woocommerce-multi-currency-switcher/)
- [WooCommerce Dynamic Pricing And Discounts](https://yaycommerce.com/yaypricing-woocommerce-dynamic-pricing-and-discounts/)

== Frequently Asked Questions ==

= Is this plugin compliant with GDPR? =
Absolutely! YaySMTP doesn't collect or store any personal information. So rest assured.
...
- Fixed: Vulnerability. Thanks to Fioravante Souza
...
= 2.0 =
- Added: Import settings from other SMTP plugins: 
1. Easy WP SMTP by wpecommerce, alexanderfoxc
2. WP Mail SMTP by WPForms
3. SMTP Mailer by naa986
4. WP SMTP by Yehuda Hassine
5. Mail Bank by Tech Banker
6. Post SMTP Mailer by Yehuda Hassine

- Improved: Notice text 
- Fixed: Small bugs

= 1.9.1 =
- Fixed: Rename PepiPost php file
