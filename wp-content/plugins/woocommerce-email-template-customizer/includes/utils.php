...
class Utils {
	...
	public static function get_accept_elements_data() {
		...
		$emails = [
			...
			'customer_delivered_order'          => $has_order_elements,
	...
	public static function get_hide_rules_data() {
		$r = [
			'default'                 => [ 'min_order', 'max_order', 'category', 'products', 'country' ],
			'customer_new_account'    => [ 'min_order', 'max_order', 'category', 'products' ],
			'customer_reset_password' => [ 'min_order', 'max_order', 'category', 'products' ]
		];
			...
			if ( $object ) {
				if ( is_a( $object, 'WC_Order' ) ) {
                    ...
                    if($user->user_login){
                        ...
                        $gender = get_user_meta($user_email, 'user_registration_user_gender', true);
                    }
	...
	public static function typed_shortcodes() {
		...
		$sc = [
			...
			'customer_delivered_order'          => $shortcode_for_order,
