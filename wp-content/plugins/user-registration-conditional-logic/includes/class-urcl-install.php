	...
	public static function plugin_row_meta( $plugin_meta, $plugin_file ) {
		...
		if ( $plugin_file == URCL_PLUGIN_BASENAME ) {
			$new_plugin_meta = array(
				'docs' => '<a href="' . esc_url( apply_filters( 'user_registration_conditional_logic_docs_url', 'https://docs.wpuserregistration.com/docs/user-registration-conditional-logic/' ) ) . '" title="' . esc_attr( __( 'View User Registration Conditional Logic Documentation', 'user-registration-conditional-logic' ) ) . '">' . __( 'Docs', 'user-registration-conditional-logic' ) . '</a>',
			);
