...
class Plugin {
	...
	public function enqueue_scripts() {
		...
		wp_register_script( 'buy-now-woo', BUY_NOW_WOO_PLUGIN_URL . 'assets/js/buy-now-woo.js', [ 'jquery' ], '1', true ); //namdeveloper

		//if ( is_product() ) {
		if ( is_product() || is_product_category() || is_archive() ) { //namdeveloper
	...
	public function add_to_cart_ajax() {
		...
		try {
			...
			$results = apply_filters( 'wsb_checkout_template', [
				...
				'checkout_url' => esc_url( wc_get_cart_url()),
