 ...
 * Plugin URI: https://wpuserregistration.com/features/conditional-logic/
		...
		private function includes() {
			...
			*/
			...
			if ( $this->is_request( 'admin' ) ) {
				...
				include_once URCL_ABSPATH . 'includes/admin/class-urcl-conditional-logic-submit.php';
				include_once URCL_ABSPATH . 'includes/admin/class-urcl-redirection-setting.php';
			}

			/**
			 * Class Ajax.
			 */
			include_once URCL_ABSPATH . 'includes/class-urcl-ajax.php';
