...
/**
 * UR_Setting_Billing_country Class
 *
 * @package  UserRegistrationWooCommerce/Form/Settings
 * @category Abstract Class
 * @author   WPEverest
 */
class UR_Setting_Billing_country extends UR_Field_Settings {
	...
	public function register_fields() {
		...
		$fields = array(
			'selected_countries' => array(
				...
				'type'     => 'select',
				'default'  => array_keys( UR_Form_Field_Billing_Country::get_instance()->get_country() ),
				'multiple' => true,
				'required' => true,
				'options'  => UR_Form_Field_Billing_Country::get_instance()->get_country(),
	...
	public function get_default_value_options() {
		...
		if ( is_array( $selected_countries ) ) {
			$value = array_intersect_key(
				UR_Form_Field_Billing_Country::get_instance()->get_country(),
...
return new UR_Setting_Billing_country();
